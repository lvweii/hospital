...
<form class="layui-form layui-form-pane" action="" id="roleForm" lay-filter="roleForm">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input class="layui-input" type="text" name="parentRoleName" id="parentRoleName" placeholder="请选择上层角色"/>
        </div>
    </div>
    <div class="layui-form-item">
