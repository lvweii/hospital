                    ...
                    <div class="form-bottom">
                        <form role="form" action="" method="post" class="login-form">
                            <div class="form-group">
                                ...
                                <input type="text" id="userId" name="userId" placeholder="请输入用户名" class="form-username form-control" id="form-username" value="admin">
                            </div>
                            <div class="form-group">
                                <label class="sr-only" for="password">密码：</label>
                                <input type="password" id="password" name="password" placeholder="请输入密码" class="form-password form-control" id="form-password" value="qaz123!@#">
                            </div>
                            <div class="form-group">
                                <div style="float: left; width: 70%;margin-bottom: 20px;">
                                    <label class="sr-only" for="captcha">验证码：</label>
                                    <input type="text" id="captcha" name="captcha" placeholder="请输入验证码" class="form-control form-captcha " id="form-captcha" value="xxxx">
                                </div>
