...
<script type="text/html" id="barOption">
    {{#  if(d.status == "0"){ }}
    <a class="layui-btn layui-btn-xs" lay-event="treat"><i class="layui-icon layui-icon-chart"></i>就诊</a>
    {{#  }else{ }}
    <a class="layui-btn layui-btn-disabled layui-btn-xs"><i class="layui-icon layui-icon-chart"></i>就诊</a>
    {{#  } }}
