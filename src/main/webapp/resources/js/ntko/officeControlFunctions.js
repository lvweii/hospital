...
function saveFileToUrl(id,mid,type)
{
	//type: 1、保存  2、提交
  var myUrl =document.forms[0].action;
  // var myUrl ="${ctxPath}/ntko/saveFileToDisk";
  // var myUrl = "http://localhost:8080/ntko/saveFileToDisk";
	// var temName = document.getElementById("temName").value;// document.all("fileName").value;
  // var temName = new Date().getTime();
	var result;
	...
	if(IsFileOpened)
	{
		...
		"type="+type+"&id="+id+"&mid="+mid,
    // "fileType="+fileType,          //与控件一起提交的参数如："p1=a&p2=b&p3=c"
		// temName,    //上传文件的名称，类似<input type=file 的value
